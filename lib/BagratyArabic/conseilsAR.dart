...
class ConseilsAR extends StatefulWidget {
  const ConseilsAR({super.key});

  @override
  ConseilsARState createState() {
    // ignore: no_logic_in_create_state
    return ConseilsARState();
  }
}

class ConseilsARState extends State<ConseilsAR> {
