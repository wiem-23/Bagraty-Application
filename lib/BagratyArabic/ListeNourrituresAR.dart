...
import 'package:bagraty_app/BagratyArabic/ApportsAR.dart';
import 'package:flutter/material.dart';

class ListenourrituresAR extends StatefulWidget {
  final String id_v;
  const ListenourrituresAR({super.key, required this.id_v});

  @override
  _ListenourrituresARState createState() => _ListenourrituresARState();
}
 ...
 */
  ...
  final TextEditingController _nomarController = TextEditingController();
            ...
            MaterialButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => ApportsAR(id_v: widget.id_v)));
                },
                child: const Text(
                  "اضافات الأعلاف ",
                  textAlign: TextAlign.center,
